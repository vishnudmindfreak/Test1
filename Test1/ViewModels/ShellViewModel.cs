...
namespace Test1.ViewModels
{
    public class ShellViewModel : Observable
    {
        ...
        private void PopulateNavItems()
        {
            ...
            _primaryItems.Add(ShellNavigationItem.FromType<Page1Page>("Shell_Page1".GetLocalized(), Symbol.Document));
            _primaryItems.Add(ShellNavigationItem.FromType<Test2Page>("Shell_Test2".GetLocalized(), Symbol.Document));
            _primaryItems.Add(ShellNavigationItem.FromType<Test3Page>("Shell_Test3".GetLocalized(), Symbol.Document));
        }
